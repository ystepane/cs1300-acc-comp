        ...
        content = `
          ...
          <div class="gif-container">
            <div class="image-wrapper">
              ...
              <img src="pics/googledoc.gif" alt="Google Sheets Standard Interaction gif. The whole process of using a mouse. Click to reveal." class="blurred-image">
              <div class="overlay">Click to reveal</div>
            </div>
            <div class="image-wrapper">
              <h3>Accessible Interaction</h3>
              <img src="pics/googledoc_acc.gif" alt="Google Sheets Accessible Interaction. The whole process of using a keyboard only. Click to reveal" class="blurred-image">
  <div class="overlay">Click to reveal</div>
            </div>
          </div>
          <h4>Reflection</h4>
      ...
      case "slack":
        content = `
          ...
          <div class="gif-container">
            <div class="image-wrapper">
              <h3>Standard Interaction</h3>
              <img src="pics/slack.gif" alt="Slack Standard Interaction. The whole process of using a mouse. Click to reveal" class="blurred-image">
              <div class="overlay">Click to reveal</div>
            </div>
            <div class="image-wrapper">
              <h3>Accessible Interaction</h3>
              <img src="pics/slack_acc.gif" alt="Slack Accessible Interaction. The whole process of using keyboard keys only. Click to reveal" class="blurred-image">
              <div class="overlay">Click to reveal</div>
            </div>
          </div>
          <h4>Reflection</h4>
      ...
      case "file-explorer":
        content = `
          ...
          <div class="gif-container">
            <div class="image-wrapper">
              <h3>Standard Interaction</h3>
              <img src="pics/explorer.gif" alt="File Explorer Standard Interaction. The whole process of using a mouse. Click to reveal" class="blurred-image">
              <div class="overlay">Click to reveal</div>
            </div>
            <div class="image-wrapper">
              <h3>Accessible Interaction</h3>
              <img src="pics/explorer_acc.gif" alt="File Explorer Accessible Interaction. The whole process of using keyboard keys only. Click to reveal" class="blurred-image">
              <div class="overlay">Click to reveal</div>
            </div>
          </div>
          <h4>Reflection</h4>
